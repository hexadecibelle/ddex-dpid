			...
			presets: [
				...
				[
					...
					'@babel/preset-env',
					{
						...
						* For all other cases, we don't transform since we want Webpack to do that in order for it to do dead code elimination (tree shaking) and intelligently select what all to add to the bundle.
						*/
